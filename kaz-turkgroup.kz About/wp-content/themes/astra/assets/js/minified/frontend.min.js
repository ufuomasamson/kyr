...
astraSmoothScroll = function(e, t) {
    ...
    function() {
                ...
                if (t && e) {
                    ...
                    if (void 0 === n) a.style.display = "none";
                        ...
                        if (-1 === n.className.indexOf("nav-menu") && (n.className += " nav-menu"), document.addEventListener("DOMContentLoaded", function() {
                            ...
                            for (r = 0, l = s.length; r < l; r++) s[r].addEventListener("focus", E, !0), s[r].addEventListener("blur", E, !0), s[r].addEventListener("click", L, !0)
                        }
        ...
        if (document.querySelectorAll(".search-field").forEach(e => {
            ...
            if (k)
                for (let e of k) e.href.split("#")[0] !== location.href.split("#")[0] ? t.push({
                    hash: e.hash,
                    url: e.href.split("#")[0]
        ...
        astra.is_scroll_to_top && (o = document.querySelector("#page header"), l = document.getElementById("ast-scroll-top"), astScrollToTopHandler(o, l), window.addEventListener("scroll", function() {
            ...
            document.querySelector(".woocommerce-store-notice__dismiss-link") ? .addEventListener("click", () => !wp ? .customize && document.body.classList.remove("ast-woocommerce-store-notice-hanged"))
        })
    }(), document.addEventListener("DOMContentLoaded", function() {
        function t(e) {
        ...
        document.querySelectorAll(".menu-link .dropdown-menu-toggle").forEach(function(e) {
