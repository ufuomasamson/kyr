    ...
    [354], {
        ...
        8738: (e, t, n) => {
            ...
            class ContactButtonsHandler extends r.default {
                ...
                bindEvents() {
                    this.elements.closeButton.addEventListener("click", this.closeChatBox.bind(this)), this.elements.chatButton.addEventListener("click", this.onChatButtonClick.bind(this)), this.elements.content.addEventListener("animationend", this.removeAnimationClasses.bind(this))
                }
                removeAnimationClasses() {
                    const {
                        ...
                        animated: i,
                        visible: r
                    } = this.getSettings("constants"), s = this.elements.content.classList.contains(e), o = this.getResponsiveSetting(t), a = this.getResponsiveSetting(n);
                    s ? (this.elements.content.classList.remove(i), this.elements.content.classList.remove(e), this.elements.content.classList.remove(a), this.elements.content.classList.remove(r)) : (this.elements.content.classList.remove(i), this.elements.content.classList.remove(o), this.elements.content.classList.add(r))
                }
                chatBoxEntranceAnimation() {
                    const {
                        ...
                        animatedWrapper: n,
                        none: i
                    } = this.getSettings("constants"), r = this.getResponsiveSetting(e);
                    i !== r && (this.elements.content.classList.add(t), this.elements.content.classList.add(r), this.elements.contentWrapper.classList.remove(n))
                }
                chatBoxExitAnimation() {
                    const {
                        ...
                        animatedWrapper: i,
                        none: r
                    } = this.getSettings("constants"), s = this.getResponsiveSetting(t);
                    r !== s && (this.elements.content.classList.add(n), this.elements.content.classList.add(e), this.elements.content.classList.add(s), this.elements.contentWrapper.classList.add(i))
                }
                openChatBox() {
                    const {
                        hasAnimations: e,
                    ...
                    this.elements.main.classList.contains(e) ? this.chatBoxEntranceAnimation() : this.elements.content.classList.add(t), this.elements.contentWrapper.classList.remove(n)
                }
                closeChatBox() {
                    const {
                        hasAnimations: e,
                    ...
                    this.elements.main.classList.contains(e) ? this.chatBoxExitAnimation() : this.elements.content.classList.remove(t), this.elements.contentWrapper.classList.add(n)
                }
                onChatButtonClick() {
                    const {
                        hidden: e
                    } = this.getSettings("constants");
                    this.elements.contentWrapper.classList.contains(e) ? this.openChatBox() : this.closeChatBox()
                }
                ...
                initChatButtonEntranceAnimation() {
                    ...
                    e !== i && (this.elements.chatButton.classList.add(n), this.elements.chatButton.classList.add(i))
                }
                onInit() {
                    super.onInit(...arguments), this.initMessageBubbleTime(), this.initChatButtonEntranceAnimation()
                }
            }
        ...
        1695: (e, t, n) => {
            ...
            var i = n(2086),
                ...
                c = n(7189);
            e.exports = function(e, t) {
                var n, u, d, h, g, m = e.target,
                    p = e.global,
                    f = e.stat;
                if (n = p ? i : f ? i[m] || a(m, {}) : (i[m] || {}).prototype)
                    for (u in t) {
                        if (h = t[u], d = e.dontCallGetSet ? (g = r(n, u)) && g.value : n[u], !c(p ? u : m + (f ? "." : "#") + u, e.forced) && void 0 !== d) {
        ...
        3278: (e, t, n) => {
            ...
            e.exports = {
                ...
                getterFor: function(e) {
                    return function(t) {
                        var n;
                        if (!l(t) || (n = r(t)).type !== e) throw p("Incompatible receiver, " + e + " required");
                        return n
                    }
                }
            }
        ...
        3712: (e, t, n) => {
            ...
            var i = n(8240),
                ...
                S = e.exports = function(e, t, n) {
                    "Symbol(" === p(g(t), 0, 7) && (t = "[" + f(g(t), /^Symbol\(([^)]*)\)/, "$1") + "]"), n && n.getter && (t = "get " + t), n && n.setter && (t = "set " + t), (!o(e, "name") || l && e.name !== t) && (a ? m(e, "name", {
                        value: t,
                        configurable: !0
                    }) : e.name = t), b && n && o(n, "arity") && e.length !== n.arity && m(e, "length", {
                        value: n.arity
                    });
                    try {
                        n && o(n, "constructor") && n.constructor ? a && m(e, "prototype", {
                            writable: !1
            ...
            e.exports = function(e, t, n, f) {
                ...
                if (w) {
                    ...
                    if (C.prototype = E, "Error" !== S ? a ? a(C, T) : l(C, T, {
                            name: !0
                        }) : m && v in w && (c(C, w, v), c(C, w, "prepareStackTrace")), l(C, w), !p) try {
