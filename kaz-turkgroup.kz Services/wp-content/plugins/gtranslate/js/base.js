(function() {
    ...
    var u_class = '.gt_raw_link-' + Array.from('base' + wrapper_selector).reduce(function(h, c) {
    ...
    if (current_lang != default_language) {
        document.querySelectorAll(u_class + '.gt-current-lang').forEach(function(e) {
            e.classList.remove('gt-current-lang')
        });
        document.querySelectorAll(u_class + '[data-gt-lang="' + current_lang + '"]').forEach(function(e) {
    ...
    if (detect_browser_language && window.sessionStorage && window.navigator && sessionStorage.getItem('gt_autoswitch') == null && !/bot|spider|slurp|facebook/i.test(navigator.userAgent)) {
        ...
        if (current_lang == default_language && preferred_language != default_language && languages.includes(preferred_language)) {
            if (url_structure == 'none') {
                ...
                document.querySelectorAll(u_class + '[data-gt-lang="' + preferred_language + '"]').forEach(function(e) {
